...
type Data = { records?: Value[]; queryReports?: Value[]; websites?: Value[]; theme?: Value | null; modules?: Value | null; permissionCatalog?: string[] };
...
function SettingsWorkbench({ data, organizationSlug }: { data: Data; organizationSlug: string }) {
  ...
  return <form action={updateTenantControls} className="grid gap-4 xl:grid-cols-2">
    <input name="organizationSlug" type="hidden" value={organizationSlug}/>
