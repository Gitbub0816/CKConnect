  ...
  if (block.type === "hero") return (
    <section className={`portal-hero portal-hero-${block.layout ?? "split"}`}>
      <div className="portal-hero-copy">
        ...
        <div className="portal-actions"><a className="portal-button" href="#contact">{block.primaryAction}<ArrowRight size={16}/></a>{block.secondaryAction && <a className="portal-button portal-button-secondary" href="#portal">{block.secondaryAction}</a>}</div>
      </div>
