  ...
  await db.$transaction(async (tx) => {
    await tx.organizationTheme.upsert({
      ...
      update: {
        ...
        consoleSidebarColor: input.consoleSidebarColor, consoleBackgroundColor: input.consoleBackgroundColor,
        consoleSurfaceColor: input.consoleSurfaceColor, consoleTextColor: input.consoleTextColor,
        consoleMutedColor: input.consoleMutedColor, consoleHeaderColor: input.consoleHeaderColor,
        consoleFont: input.consoleFont, consoleRadius: input.consoleRadius, consoleDensity: input.consoleDensity,
        consoleNavigationStyle: input.consoleNavigationStyle, paymentTitle: input.paymentTitle || null,
        paymentSubtitle: input.paymentSubtitle || null, paymentLogoUrl: input.paymentLogoUrl || null,
        paymentBackgroundImageUrl: input.paymentBackgroundImageUrl || null, paymentPrimaryColor: input.paymentPrimaryColor,
        paymentHeaderColor: input.paymentHeaderColor, paymentBackgroundColor: input.paymentBackgroundColor,
        paymentSurfaceColor: input.paymentSurfaceColor, paymentTextColor: input.paymentTextColor,
        paymentMutedColor: input.paymentMutedColor, paymentFont: input.paymentFont,
        paymentRadius: input.paymentRadius, paymentFooterText: input.paymentFooterText || null,
      },
      create: {
